...
Take the sum of the coefficients given in that branch representation for each split to get a split-based parameterization of the lognormal.
Calculate the derivatives as above.
Then set the derivative that is participating in a given split to the corresponding element of the lognormal derivative.
