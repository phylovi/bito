...
#undef YYCASE_
  ...
  "\")\"", "\"taxon\"", "\"quoted_taxon\"", "\"float\"", "\":\"",
  "$accept", "tree", "fancy_node", "node", "leaf", "inner_node",
  "node_list", YY_NULLPTR
  };
