...
std::vector<double> SBNInstance::ParameterGradients() const {
  return beagle::ParameterGradients(beagle_instances_, tree_collection_, rescaling_, q_differential, freqs, evec, ivec, eval); 
}
