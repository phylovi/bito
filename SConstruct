...
env = Environment(ENV=os.environ, CPPPATH=['include', 'src'], CCFLAGS=['-g', '-Wall', '-Wextra', '-Wconversion'], CXXFLAGS=['-std=c++14'])
...
doctest = env.Program(['_build/doctest.cpp', '_build/driver.o', '_build/parser.o', '_build/scanner.o'])
